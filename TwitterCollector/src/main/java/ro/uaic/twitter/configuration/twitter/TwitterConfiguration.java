package ro.uaic.twitter.configuration.twitter;
...
public class TwitterConfiguration {
    ...
    public TwitterConfiguration(String config) {
        try (InputStream inputStream = new FileInputStream(getClass().getClassLoader().getResource("twitterAuth.properties").getFile())) {
